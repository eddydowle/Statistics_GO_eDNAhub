...
author: "GJ Jeunen, K Fernandes, E Dowle"
...
#install.packages('tidyverse', 'viridis', 'indicspecies', 'vegan', 'glue', 'reshape2')
...
setwd("H:/Otago/Teaching/Genetics_otago")
#set to yours
## read in the data and metadata
df <- read.delim('zotutableFTP142Combined.txt', check.names = FALSE, row.names = 1)
tax <- read.delim('consensusTaxonomyFormatFTP142Combined.txt', check.names = FALSE, row.names = 1, header = T)
meta <- read.csv('FTP142SampleMetadata.csv', check.names = FALSE, row.names = 1) 
...
meta_env <- read.csv('FTP142SampleEnvVariables.csv', check.names = FALSE, row.names = 1) #has the sample numbers removed - makes interpretation easier....
